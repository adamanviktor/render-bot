...
# Constants
URL_BASE = "https://www.oddsmath.com/football/matches/"
...
def fetch_matches_for_date(date_str):
    ...
    try:
        ...
        match_links = soup.select(".event-table tr a")
        return ["https://www.oddsmath.com" + link['href'] for link in match_links if '/match/' in link['href']]
